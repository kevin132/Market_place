...
<section id="promo">
    <h2 class="info-shop text-center">Simplifiez vos achats</h2>
    <div class="container">
        <p class="description text-center">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad autem consequuntur debitis distinctio dolorem eius enim incidunt iusto, labore magni mollitia nesciunt obcaecati optio quisquam reiciendis rem sint voluptatem voluptates.</p>
    </div>
